...
%         current_of_interest=medfilt1(current_of_interest,100);
        ...
        current_of_interest_waves(trial_number,:)=medfilt1(current_of_interest,5);
        ...
        [current_amp_first,lk_trace,width_trace, spike_amp_trace]=findpeaks(medfilt1(current_of_interest(1000:end),1),'MinPeakHeight',15,'MinPeakDistance',100,'MinPeakWidth', 50);
        ...
        charge_first_allwaves(trial_number)=trapz(1/sampling_rate,current_of_interest(30:6030));
